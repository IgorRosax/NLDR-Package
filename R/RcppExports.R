...
getNeighborhoodMatrix <- function(data, k, symmetric) {
    .Call(`_RcppHSLocalMDS_getNeighborhoodMatrix`, data, k, symmetric)
}
...
getNeighborhoodVector <- function(data, k) {
    .Call(`_RcppHSLocalMDS_getNeighborhoodVector`, data, k)
}
...
getEuclideanDistanceMatrix <- function(data) {
    .Call(`_RcppHSLocalMDS_getEuclideanDistanceMatrix`, data)
}
...
getParameterT <- function(data, neighborhood, tau) {
    .Call(`_RcppHSLocalMDS_getParameterT`, data, neighborhood, tau)
}
...
getHSLocalMdsStress <- function(data, confVec, neighborhood, notNeighborhood, Rn, tt, Gamma) {
    .Call(`_RcppHSLocalMDS_getHSLocalMdsStress`, data, confVec, neighborhood, notNeighborhood, Rn, tt, Gamma)
}
...
getHSLocalMdsStressGradient <- function(data, confVec, neighborhood, notNeighborhood, Rn, tt, Gamma) {
    .Call(`_RcppHSLocalMDS_getHSLocalMdsStressGradient`, data, confVec, neighborhood, notNeighborhood, Rn, tt, Gamma)
}
...
getHSMdsStress <- function(data, confVec, Rn, Gamma) {
    .Call(`_RcppHSLocalMDS_getHSMdsStress`, data, confVec, Rn, Gamma)
}
...
getHSMdsStressNormalized <- function(data, confVec, Rn, Gamma) {
    .Call(`_RcppHSLocalMDS_getHSMdsStressNormalized`, data, confVec, Rn, Gamma)
}
...
getHSMdsStressGradient <- function(data, confVec, Rn, Gamma) {
    .Call(`_RcppHSLocalMDS_getHSMdsStressGradient`, data, confVec, Rn, Gamma)
}
...
RcppGetLocalContinuityMetaCriterion <- function(data, conf, Rn, k) {
    .Call(`_RcppHSLocalMDS_RcppGetLocalContinuityMetaCriterion`, data, conf, Rn, k)
}
...
RcppGetLocalContinuityMetaCriterionByVector <- function(data, conf, Rn, k) {
    .Call(`_RcppHSLocalMDS_RcppGetLocalContinuityMetaCriterionByVector`, data, conf, Rn, k)
}
...
#' 
#' @export
RcppOptimHSMds <- function(data, conf, Rn, Gamma, maxIt, optMethod) {
    .Call(`_RcppHSLocalMDS_RcppOptimHSMds`, data, conf, Rn, Gamma, maxIt, optMethod)
}
...
#' 
#' @export
RcppOptimHSLocalMds <- function(data, conf, neighborhood, notNeighborhood, Rn, tt, Gamma, maxIt, optMethod) {
    .Call(`_RcppHSLocalMDS_RcppOptimHSLocalMds`, data, conf, neighborhood, notNeighborhood, Rn, tt, Gamma, maxIt, optMethod)
}
...
#' 
#' @export
RcppHSMDS <- function(data, conf, Rn = 2L, Kquality = 2L, verbose = FALSE, applyHiperbolicSmoothing = TRUE, gamma = 1, n_gamma = 30L, rho = 0.5, maxIt = 30L, optMethod = "CG") {
    .Call(`_RcppHSLocalMDS_RcppHSMDS`, data, conf, Rn, Kquality, verbose, applyHiperbolicSmoothing, gamma, n_gamma, rho, maxIt, optMethod)
}
...
#' 
#' @export
RcppHSlocalMDS <- function(data, conf, Rn = 2L, Kproj = 5L, Kquality = 0L, verbose = FALSE, selectBetterUnitFree = FALSE, smallerUnitFree = 0.0001, n_t = 10L, ratio = 3.162278, applyHiperbolicSmoothing = TRUE, gamma = 1, n_gamma = 30L, rho = 0.5, maxIt = 30L, optMethod = "CG") {
    .Call(`_RcppHSLocalMDS_RcppHSlocalMDS`, data, conf, Rn, Kproj, Kquality, verbose, selectBetterUnitFree, smallerUnitFree, n_t, ratio, applyHiperbolicSmoothing, gamma, n_gamma, rho, maxIt, optMethod)
}
